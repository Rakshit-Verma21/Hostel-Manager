package com.example.my_hostel.Adapters.Hostelers;
...
import com.example.my_hostel.Hostelers.View_Hostler_Details;
...
public class Main_activity_hosteler_Adapter extends RecyclerView.Adapter<Main_activity_hosteler_Adapter.Hostler_ViewHolder>
{
    ...
    public Main_activity_hosteler_Adapter(Context context, ArrayList<String> uid_hostlers, RecyclerView rv) {
    ...
    {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_hosteler_main_activity,parent,false);
