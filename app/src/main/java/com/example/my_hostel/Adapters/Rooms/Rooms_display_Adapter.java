package com.example.my_hostel.Adapters.Rooms;
...
import com.example.my_hostel.Rooms.View_Room_Details;
...
public class Rooms_display_Adapter extends RecyclerView.Adapter<Rooms_display_Adapter.Room_Viewholder>
{
    ...
    {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_room_management_activity,parent,false);
    ...
    public void onBindViewHolder(@NonNull Room_Viewholder holder, int position)
    {
            ...
            reference.child("Users").child(user.getUid()).child("Rooms").child(room_uid_list.get(position)).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists())
                    {
                        holder.room_name.setText("Room: "+room_uid_list.get(position));
                        ...
                        holder.room_price.setText("Rs. " + snapshot.child("Price").getValue().toString());
                    }
    ...
    {
        private TextView room_name,room_status,room_size,room_type,room_price;
        public Room_Viewholder(@NonNull View itemView) {
            ...
            room_price=itemView.findViewById(R.id.room_cv_price);
        }
    }
