...
{
    private TextView room_name_confirmed,room_size_confirmed,room_type_confirmed,room_price_confirmed;
    private EditText room_name,room_size,room_type,room_price;
    private Button add_room_button_confirm,add_room_button_add;
    int count=0;

    private String ROOM_NUMBER,ROOM_TYPE;
    private int ROOM_SIZE,ROOM_PRICE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        room_price_confirmed=findViewById(R.id.textView75);
        ...
        room_price.addTextChangedListener(new TextWatcher() {
            @Override
            public void afterTextChanged(Editable editable) {
                room_price_confirmed.setText("Type : "+room_price.getText().toString());
            }
    ...
    private  void update_Database()
    {
        ...
        database.child("Users").child(user.getUid()).child("Rooms").child(ROOM_NUMBER).child("Price").setValue(ROOM_PRICE);
    ...
    {
        if(!room_name.getText().toString().isEmpty() && !room_size.getText().toString().isEmpty() && !room_type.getText().toString().isEmpty() && !room_price.getText().toString().isEmpty())
        {
            ...
            else if(room_price.getText().toString().length()<2)
            {
                Toast.makeText(this,"The Price Should be Greater than 2 Characters Example 2000",Toast.LENGTH_SHORT).show();
            }
            else
            {
                ...
                String room_price_string=room_price.getText().toString();
                confirm_room_details(room_name_string,room_size_string,room_type_string,room_price_string);
    ...
    private void confirm_room_details(String room_name,String room_size,String room_type,String room_price)
    {
        ...
        room_price_confirmed.setText("Type : "+room_price);
        ROOM_PRICE=Integer.parseInt(room_price);
        ROOM_TYPE=room_type;
