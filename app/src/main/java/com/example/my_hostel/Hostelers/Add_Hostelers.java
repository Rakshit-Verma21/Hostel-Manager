package com.example.my_hostel.Hostelers;
...
import com.example.my_hostel.Adapters.Rooms.room_mates_list_Adapter;
...
public class Add_Hostelers extends AppCompatActivity
{
    ///Components
    ...
    private  TextView hosteler_date_of_joining;
    private ImageButton clear_date;
    ///Education Details
   ...
   private  ProgressBar progressBar;
    ...
    private TextView room_price_display;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        hosteler_date_of_joining = findViewById(R.id.hosteler_date_of_joining);
        clear_date = findViewById(R.id.clear_date_button);
        ///Education Details
        ...
        room_price_display=findViewById(R.id.assign_room_room_price);
        ...
        assign_room_back_button.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Toast.makeText(Add_Hostelers.this,"Room Not Assigned",Toast.LENGTH_SHORT).show();
                ...
                finish();
                startActivity(new Intent(Add_Hostelers.this, Mangement_Hostelers.class));
            }
        });
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (Occupied_no != size) {
                                ...
                                if (Occupied_no + 1 == size) {
                                    ...
                                    Toast.makeText(Add_Hostelers.this, "Room Is Now Full", Toast.LENGTH_SHORT).show();
                                }
                                Toast.makeText(Add_Hostelers.this, "Room Assigned", Toast.LENGTH_SHORT).show();
                                finish();
                                startActivity(new Intent(Add_Hostelers.this, Mangement_Hostelers.class));
                            }
                        }
        ...
        ///  Date Selector for Date of Joining
        hosteler_date_of_joining.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Add_Hostelers.this,(view1,selectedYear, selectedMonth, selectedDay) -> {
                    hosteler_date_of_joining.setText(selectedDay + "/" + (selectedMonth + 1) + "/" + selectedYear);
                }, year, month, day);
                datePickerDialog.getDatePicker().setMinDate(Calendar.getInstance().getTimeInMillis());
                Calendar maxCalendar = Calendar.getInstance();
                maxCalendar.add(Calendar.MONTH, 4);
        ...
        clear_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                hosteler_date_of_joining.setText("Click to Select Date");
                Toast.makeText(Add_Hostelers.this, "Date Cleared", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getRoomDetails_For_RoomAssingment(String roomName)
    {
        ...
        reference.child("Users").child(user.getUid()).child("Rooms").child(roomName).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                room_price_display.setText("Price : Rs " + price);
                if(is_empty.equals("True"))
                {
                    room_shared_display.setText("Room is Empty");
                    rv_other_roommates_list.setVisibility(View.GONE);
                }
                else
                {
                    rv_other_roommates_list.setVisibility(View.VISIBLE);
                    ...
                    {
                        if(!room_mates_id_list.contains(snap.getKey())){
                ...
                .addValueEventListener(new ValueEventListener()
                {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                    {
                        ...
                        for (DataSnapshot snap : dataSnapshot.getChildren())
                        {
                            ...
                            {
                                Add_Hostelers.this.room.add(room);
                            }
                        }
    ...
    private void handle_information(int type)
    {
        ...
        ///Date of Joining
        String date_of_joining=hosteler_date_of_joining.getText().toString();
        ///Education Details
        ...
        if(type==1)
        {
            if (name.isEmpty() || address.isEmpty() || date_of_joining.equals("Click to Select Date")||education_details.isEmpty() || phone_number.isEmpty() || current_degree.isEmpty() || college.isEmpty() || father_name.isEmpty() || mother_name.isEmpty() || father_phone_number.isEmpty() || mother_phone_number.isEmpty()) {
            ...
            else if(date_of_joining.equals("Click to Select Date"))
            {
            ...
            else if(father_phone_number.length()!=10 )
            {
                Toast.makeText(this, "Please Enter Valid Father's Phone Number", Toast.LENGTH_SHORT).show();
            }
            else if(mother_phone_number.length()!=10 )
            {
                Toast.makeText(this, "Please Enter Valid Mother's Phone Number", Toast.LENGTH_SHORT).show();
            }
            else {
        ...
        else if(type==2)
        {
            ...
            databaseEntry(date_of_joining,name, address, education_details, phone_number, current_degree, college, father_name, mother_name, father_phone_number, mother_phone_number, type_document);
        }
    }
    private void databaseEntry(String date_of_joining,String name,String address,String education_details,String phone_number,String current_degree,String college,String father_name,String mother_name,String father_phone_number,String mother_phone_number,int type_document)
    {
        ...
        reference.child("Users").child(user.getUid()).child("Hostlers").child(uid).child("Personal Details").child("Date of Joining").setValue(date_of_joining);
        ...
        {
            Toast.makeText(Add_Hostelers.this, "No Documents are Uploaded", Toast.LENGTH_SHORT).show();
        }
        storageReference.child(user.getUid()).child("Hostlers").child(uid).child("Profile").child("profile.jpg").putFile(profile_pic_uri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task)
            {
                if(task.isSuccessful())
                {
                    ...
                    Toast.makeText(Add_Hostelers.this, "All Documents are Uploaded", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
            ...
            {
                Toast.makeText(Add_Hostelers.this, "Error Uploading Documents", Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
                add_hosteler_final.setVisibility(View.GONE);
                save_hostler_details_button.setVisibility(View.VISIBLE);
                edit_hostler_details_button.setVisibility(View.GONE);
