...
import com.example.my_hostel.Adapters.Hostelers.ManagementHostlers_Display_Adapter;
...
public class Mangement_Hostelers extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        EditText seatchEditText = search_hostlers.findViewById(androidx.appcompat.R.id.search_src_text);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.add_hostelers) {
            startActivity(new Intent(Mangement_Hostelers.this, Add_Hostelers.class));
            finish();
        }
